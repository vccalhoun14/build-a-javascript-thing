...
if (window.localStorage) {
  ...
  // }, false);
  // txtTitle1.addEventListener('input', function () {      // Data saved on keyup
  //   localStorage.setItem('title1', txtTitle1.value);
  // }, false);
  // txtSubtitle1.addEventListener('input', function () {      // Data saved on keyup
  //   localStorage.setItem('subtitle1', txtSubtitle1.value);
  // }, false);
  // txtAuthor2.addEventListener('input', function () {      // Data saved on keyup
  //   localStorage.setItem('author2', txtAuthor2.value);
  // }, false);
  // txtTitle2.addEventListener('input', function () {      // Data saved on keyup
  //   localStorage.setItem('title2', txtTitle2.value);
  // }, false);
  // txtSubtitle2.addEventListener('input', function () {      // Data saved on keyup
